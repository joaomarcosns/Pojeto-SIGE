...
@WebServlet(urlPatterns = {"/cadastrar-encomenda"})
public class CadastrarEncomendasController extends HttpServlet {
	
	private static final long serialVersionUID = 1L;
	EncomendaDAO encomendaDAO = new EncomendaDAO();

    public CadastrarEncomendasController() {
        super();
    }
   
    @Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/cadastrar-encomenda.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(validaRemetente && validaDestinatario && validaEncomenda) {
    		...
    		try {
    			...
    			encomenda.setLargura(Double.parseDouble(altura));
